            ...
            <div className="about-content">
                ...
                <div className="values-list">
                    <div className="value-item" style={{ padding: 16, display: 'flex', alignItems: 'center', gap: '20px', background: '#e8eef7' }}>
                        ...
                        <img src="/site-datalinker/team/gleidson.png" alt="Gleidson Luis Chagas Medeiros" style={{ width: '150px', height: '150px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} />
                    </div>
                    ...
                    <div className="value-item" style={{ padding: 16, display: 'flex', alignItems: 'center', gap: '20px', background: '#e8eef7' }}>
                        ...
                        <img src="/site-datalinker/team/fabiano.png" alt="Fabiano Silva dos Santos" style={{ width: '150px', height: '150px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} />
                    </div>
                    ...
                    <div className="value-item" style={{ padding: 16, display: 'flex', alignItems: 'center', gap: '20px', background: '#e8eef7' }}>
                        ...
                        <img src="/site-datalinker/team/guilherme(1).png" alt="Guilherme Alves Mederos" style={{ width: '150px', height: '150px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} />
                    </div>
                    ...
                    <div className="value-item" style={{ padding: 16, display: 'flex', alignItems: 'center', gap: '20px', background: '#e8eef7' }}>
                        ...
                        <img src="/site-datalinker/team/pedro-henrique.jpg" alt="Pedro Henrique Lima da Cruz" style={{ width: '150px', height: '150px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} />
                    </div>
                </div>
            </div>
        </main>
